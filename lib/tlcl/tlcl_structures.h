...
#ifndef TPM_LITE_TLCL_STRUCTURES_H_
#define TPM_LITE_TLCL_STRUCTURES_H_
...
const struct s_tpm_reset_cmd {
	uint8_t buffer[10];
} tpm_reset_cmd = {{0x0, 0xc1, 0x0, 0x0, 0x0, 0xa, 0x0, 0x0, 0x0, 0x5a}};
